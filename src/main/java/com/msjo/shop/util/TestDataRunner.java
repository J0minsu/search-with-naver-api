...
import com.msjo.shop.naver.service.NaverApiService;
import com.msjo.shop.repository.ProductRepository;
import com.msjo.shop.repository.UserRepository;
import com.msjo.shop.service.UserService;
...
import static com.msjo.shop.service.ProductService.MIN_MY_PRODUCT;
...
public class TestDataRunner implements ApplicationRunner {
    ...
    private void createTestData(User user, String searchWord) {
        ...
        for (ItemDto itemDto : itemDtoList) {
            ...
            int myPrice = getRandomNumber(MIN_MY_PRODUCT, itemDto.getLprice() + 10000);
